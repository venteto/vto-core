# Generated by Django 5.2b1 on 2025-03-14 13:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('uuid_pk_v7', models.UUIDField(default=uuid6.uuid7, editable=False, primary_key=True, serialize=False)),
                ('slug', models.CharField(help_text='Western_European_Summer_Time', max_length=50, unique=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='DemoTestTimestamp',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('dst', models.BooleanField(default=False)),
                ('ts_unix', models.PositiveIntegerField(help_text='1741035602')),
                ('ts_utc', models.DateTimeField(blank=True, null=True)),
                ('exchange', models.ForeignKey(default='NYSE', on_delete=django.db.models.deletion.PROTECT, to='vto_core.demoexchange', to_field='abbr')),
            ],
            options={
                'ordering': ['ts_unix'],
            },
        ...
        migrations.AddField(
            model_name='demoexchange',
            name='tz',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='vto_core.timezone'),
        ),
        migrations.CreateModel(
            name='User',
            fields=[
        ...
        migrations.AddField(
            model_name='tzabbreviation',
            name='wiki_slug',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='rn_tz_abbr_wiki', to='vto_core.tzwikislug'),
        ),
    ]
